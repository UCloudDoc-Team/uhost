...
|             | 特点                   | 适用场景             |
| ----------- | -------------------- | ---------------- |
| 快杰型 O  | 计算、存储、网络性能卓越，性价比极高的的最新一代云主机 | 全面场景  |
| 高主频型 C      | 采用3.2GHz主频的CPU与SSD本地磁盘，计算性能强 | 高频交易，数据处理，图形渲染等  |
| GPU型 G      | 搭载K80，P40或V100 GPU   | 人工智能，科学计算，图形渲染等  |
| 通用型 N       | 上一代云主机，配置自由灵活，选择丰富          | 企业级应用，内存服务，数据分析等 |
...
- 在Web服务，游戏服务，数据库，数据分析处理，等绝大多数场景表现出色。
...
1）简介：上一代云主机，提供最灵活自由的CPU、内存、磁盘组合。适合计算、存储、网络等均衡的场景。
