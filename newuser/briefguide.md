...
**说明**：如果您尚未注册ucloud账号，请先注册账号。

操作流程：选择地域可用区—>选择镜像、CPU及内存—>配置网络—>配置管理相关项目—>选择付费方式并支付。
...
**说明**：带宽提供带宽计费、流量计费以及共享带宽三种计费模式，如您想详细了解计费价格，请阅读[带宽计费](https://docs.ucloud.cn/unet/README)。
...
**说明**：选择付费方式：“月付”——>“购买至月末”即表示该订单付款至当前月末，下一期订单从下个月1号零点开始计算。
