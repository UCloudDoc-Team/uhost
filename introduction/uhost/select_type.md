# 机型选择
当前，Ucloud为用户提供7款不同类型的云主机。为了让用户能够精准的找到与业务场景相匹配的最佳云主机，本文将介绍Ucloud各款云主机的特点，性能表现，适用场景等相关内容。 <br>
[快杰O型 Ampere版](#1.1)

## <div id="1.1">快杰O型 Ampere版<div>
### 产品介绍
...
- CPU平台：
  ...
  - Ampere® Altra® Q80-30处理器基于ARM Neoverse N1企业级内核架构，四发射超标量乱序执行，支持ARM v8.2指令集
