...
| ----- | ---- | ------------- | ------------- | ----------------- |
| 华北（北京）   | 可用区A | 10.255.255.1  | 10.255.255.2  | 0.cn.pool.ntp.org |
| 华北（北京2）   | 可用区B | 10.9.255.1    | 10.9.255.2    | 0.cn.pool.ntp.org |
| 华北（北京2）   | 可用区C | 10.10.255.1   | 10.10.255.2   | 0.cn.pool.ntp.org |
| 华北（北京2）   | 可用区D | 10.19.255.1   | 10.19.255.2   | 0.cn.pool.ntp.org |
| 华北（北京2）   | 可用区E | 10.42.255.1   | 10.42.255.2   | 0.cn.pool.ntp.org |
| 华北（乌兰察布）   | 可用区A | 100.65.128.2   | 100.65.128.3   | 0.cn.pool.ntp.org |
| 华南（广州）    | 可用区B | 10.13.255.1   | 10.13.255.2   | 0.cn.pool.ntp.org |
| 金融云-华东（上海） | 可用区A | 10.15.255.1   | 10.15.255.2   | 0.cn.pool.ntp.org |
| 华东（上海2）   | 可用区A | 10.23.255.101 | 10.23.255.102 | 0.cn.pool.ntp.org |
| 华东（上海2）   | 可用区B | 10.23.255.101 | 10.23.255.102 | 0.cn.pool.ntp.org |
| 香港    | 可用区A | 10.8.255.1    | 10.8.255.2    | 0.cn.pool.ntp.org |
| 香港    | 可用区B | 10.8.255.1    | 10.8.255.2    | 0.cn.pool.ntp.org |
| 美国（洛杉矶）   | 可用区A | 10.11.255.1   | 10.11.255.2   | 0.cn.pool.ntp.org |
| 美国（华盛顿）   | 可用区A | 10.27.255.101 | 10.27.255.102 | 0.cn.pool.ntp.org |
| 新加坡   | 可用区A | 10.35.255.1   | 10.35.255.2   | 0.cn.pool.ntp.org |
| 泰国（曼谷）    | 可用区A | 10.31.255.101 | 10.31.255.102 | 0.cn.pool.ntp.org |
| 高雄    | 可用区A | 10.37.255.101 | 10.37.255.102 | 0.cn.pool.ntp.org |
| 台湾（台北）    | 可用区A | 10.41.255.1   | 10.41.255.2   | 0.cn.pool.ntp.org |
| 印度尼西亚（雅加达）   | 可用区A | 10.45.255.1   | 10.45.255.2   | 0.cn.pool.ntp.org |
| 印度（孟买）    | 可用区A | 10.47.255.1   | 10.47.255.2   | 0.cn.pool.ntp.org |
| 韩国（首尔）    | 可用区A | 10.33.255.101 | 10.33.255.102 | 0.cn.pool.ntp.org |
| 日本（东京）    | 可用区A | 10.40.255.1   | 10.40.255.2   | 0.cn.pool.ntp.org |
| 德国（法兰克福）  | 可用区A | 10.29.255.101 | 10.29.255.102 | 0.cn.pool.ntp.org |
| 阿联酋（迪拜）    | 可用区A | 10.44.255.1   | 10.44.255.2   | 0.cn.pool.ntp.org |
| 巴西（圣保罗）   | 可用区A | 10.49.255.1   | 10.49.255.2   | 0.cn.pool.ntp.org |
