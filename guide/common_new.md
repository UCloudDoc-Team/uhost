...
4.创建时长（删除时间-创建时间）7天的云主机被删除后将进入回收站，可以从回收站恢复；[详情](uhost/guide/recycle_bin)<br>
...
## 重装系统
操作路径：选择主机——>【…】——>【更多操作】——>【重装系统】<br>

![img](/guide/image/reset.png)<br>

**说明**<br>
1.如您重装系统时，免费镜像重装为收费镜像，需补足差价，收费镜像重装为免费镜像，系统会发起退费；<br>
